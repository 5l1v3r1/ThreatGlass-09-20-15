...
var jquerypopupmenu={
	...
	positionul:function($, $ul, e){
		...
		var menuDiv = document.getElementById('d_main_menu');
		...
		if (istoplevel){ //if main popup menu DIV
			...
			//var point = fGetXY(d_main_menu);
			
			document.getElementById("d_main_menu").style.display = "block"
			var point = fGetXY(menuDiv);
		
			//alert(point.x);
			
			x= point.x;
			y= point.y + menuDiv.offsetHeight;
			//y=0;
		}
